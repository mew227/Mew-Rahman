...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ ─꯭─⃝‌‌𝐌𝐞𝐰 𝐐𝐮𝐞𝐞𝐧 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭 এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..!", threadID, () => {
...
★ যেকোনো অভিযোগ অথবা হেল্প এর জন্য এডমিন 𝐌𝐞𝐰 𝐐𝐮𝐞𝐞𝐧 কে নক করতে পারেন ★
...
➤ প্রেম করতে ইচ্ছা হলে কিংবা কুনো সমস্যা হলে গ্রুপের এডমিন দের জানাবেন।
